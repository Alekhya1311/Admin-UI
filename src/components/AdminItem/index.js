...
class AdminItem extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({ newEmail: admin.email, newName : admin.name, newRole: admin.role });
  }
...
render() {
  ...
  return (
      ...
      <div className="admin-item-container">
        ...
        {
          editMode ? <input type="text" className = "input" onChange = {this.name} /> : 
        ...
        {
          editMode ? <BiSave className = "edit" onClick={() => {
